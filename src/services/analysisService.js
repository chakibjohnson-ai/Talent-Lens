...
export const AnalysisSchema = z.object({
  ...
  data: z.object({
    ...
    matched_roles:           z.array(VerticalItem).optional().default([]),
    suggested_roles:         z.array(VerticalItem).optional().default([]),
    matched_industries:      z.array(VerticalItem).optional().default([]),
    suggested_industries:    z.array(VerticalItem).optional().default([]),
    contact: z.object({
